...
export default function App() {
  ...
  return (
    <div className={`app-container ${theme}-primary `}>
      <div className="app-left">
        ...
        <div className={`app-profile-box ${theme}-secendary`}>
          <img
        ...
        <div className="chat-list-wrapper">
          ...
          <ul className="chat-list active">
            <li className={`chat-list-item active ${theme}-secendary`}>
              <img
        ...
        <div className="chat-list-wrapper">
          <div className="chat-list-header active">
            Achived Conversations <span className="c-number">3</span>
            <svg
              className="list-header-arrow"
              xmlns="http://www.w3.org/2000/svg"
              width={16}
      ...
      <div className={`app-main ${theme}-secendary`}>
        ...
        <div className={`chat-input-wrapper ${theme}-primary`}>
          ...
          <div className={`input-wrapper ${theme}-secendary`}>
            <input
              type="text"
      ...
      <div className="app-right">
        ...
        <div className={`app-activity-box ${theme}-secendary`}>
